...
class CartController extends Controller
{
    ...
    public function index() {
        ...
        $userinfo=User::select('users.name','users.email','users.mobile')->where('users.id',$user_id)
        ->get()->first();
        ...
        return view('front.cart', compact('cartdata','getabout','getpromocode','taxval','userinfo','getdata'));
    }
