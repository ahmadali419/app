...
Route::group(['prefix' => 'admin', 'namespace' => 'admin'], function () {
	...
	Route::group(['middleware' => ['AdminAuth']],function(){
		...
		Route::get('dashboard/subscription_requests', 'SubsRequestController@index');
		Route::get('subscription_requests/approve/{id}', 'SubsRequestController@requestApprove');
		Route::get('subscription_requests/decline/{id}', 'SubsRequestController@requestDecline');
