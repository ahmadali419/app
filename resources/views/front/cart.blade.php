            ...
            @else 
                ...
                <div class="col-lg-4">
                    ...
                    <div class="cart-summary">
                        ...
                        <p class="pro-total">Product Total <span><?php echo env('CURRENCY'); ?>{{number_format($order_total, 2)}}</span></p>
                        <p class="pro-total">Tax({{$taxval->tax}}%) <span><?php echo env('CURRENCY'); ?>{{number_format($taxprice, 2)}}</span></p>
                        <p class="pro-total" id="delivery_charge_hide">Delivery Charge<span><?php echo env('CURRENCY'); ?>{{number_format($taxval->delivery_charge, 2)}}</span></p>

                        @if (Session::has('offer_amount'))
                            <p class="pro-total offer_amount">Discount ({{Session::get('offer_code')}})</span>
                                <span id="offer_amount">
                                    -<?php echo env('CURRENCY'); ?>{{number_format($order_total*Session::get('offer_amount')/100, 2)}}
                                </span>
                            </p>
                        @else
                        ...
                        @if (Session::has('offer_amount'))
                            ...
                            <p class="cart-total">Total 
                                <span id="total_amount">
                                    <?php echo env('CURRENCY'); ?>{{number_format($order_total+$taxval->delivery_charge+$taxprice-$order_total*Session::get('offer_amount')/100, 2)}}
                                </span>
                            </p>
                        @else
                            <p class="cart-total">Total <span id="total_amount"><?php echo env('CURRENCY'); ?>{{number_format($total, 2)}}</span></p>
                        @endif
