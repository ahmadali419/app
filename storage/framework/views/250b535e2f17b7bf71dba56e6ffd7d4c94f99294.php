                    ...
                    <form id="updated_package" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="package_name"
                                            id="getpackage_name" value="<?php echo e($package->package_name); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="package_validity" class="col-form-label">Package Validity:</label>
                                        <select name="package_validity" id="getpackage_validity" class="form-control" value="<?php echo e($package->package_validity); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="meals" id="getmeals" class="form-control" value="<?php echo e($package->meals); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="package_amount"
                                            id="package_amount"  value="<?php echo e($package->package_amount); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="image" id="image"
                                    accept=".png, .jpg, .jpeg" value="<?php echo e($package->image); ?>">
                                    <input type="hidden" class="form-control" id="old_img" name="old_img" value="<?php echo e($package->image); ?>">
                                    <!-- <img src='<?php echo asset("public/images/packages/".$package->image); ?>' alt="" style='max-height: 200px;'>  -->
                                    <!-- <img src="<?php echo e($package->image); ?>" class='img-fluid' style='max-height: 200px;'> -->
                            </div>
                            <div>
                                <h3>Food Information
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="food_name[<?php echo $i; ?>]"
                                                id="getfood_name" value="<?php echo e($category->food_name); ?>">
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="food_description[<?php echo $i; ?>]"
                                                id="food_description" placeholder="2 meals,3 carbohydrate,price" value="<?php echo e($category->food_description); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="food_image[<?php echo $i; ?>]"
                                                id="food_image[0]" value="<?php echo e($category->food_image); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" cols="10" rows="5"
                                    class="form-control" value="<?php echo e($package->description); ?>"></textarea>
                            </div>
...
function removerow(thisis){
        ...
        $.ajax({
            ...
            url:"<?php echo e(URL::to('admin/packages/updatePackage')); ?>",
            method:"POST",
            data:form_data,
            cache: false,
            contentType: false,
...
</script><?php /**PATH D:\new-xampp\htdocs\app\resources\views/front/editPackage.blade.php ENDPATH**/ ?>